...
We intentionally use simple models so that predictive performance reflects structure already present in the embeddings rather than complex nonlinear modeling.
Performance will be evaluated using $k$-fold cross-validation.
